...
#define LSM6DSR_SENSOR_ADDR 0x01
...
{
    return i2c_master_write_to_device(handle, Reg, len, Bufp, I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
}

int32_t platform_read(void *handle, uint8_t Reg, uint8_t *Bufp, uint16_t len)
{
    return i2c_master_write_read_device(handle, LSM6DSR_SENSOR_ADDR, Bufp, 1, Bufp, len, I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
}
